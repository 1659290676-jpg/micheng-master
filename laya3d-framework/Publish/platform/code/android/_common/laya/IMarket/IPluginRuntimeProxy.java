package com.xingyun.game.IMarket;
...
public abstract interface IPluginRuntimeProxy {
	...
	//调用方法
	public abstract void InvokeMethod(JSONObject jsonObj, ValueCallback<JSONObject> callback);
	//初始化sdk
	public abstract void InitSdk(JSONObject jsonObj, ValueCallback<JSONObject> callback);
	//登录
	public abstract void Login(JSONObject jsonObj, ValueCallback<JSONObject> callback);
    //注销登录
    public abstract void Logout(ValueCallback<JSONObject> callback);
	//支付

...
/***/ (function(module, exports) {
	...
	if (true) {
	  ...
	  var Perf = Date;
	  var initTime = Perf.now();

	  var clientPerfAdapter = Object.assign({}, Perf, {
	    now: function now() {
	      return (Perf.now() - initTime) / 1000;
	    }
	  });

	  //performance = platform === 'devtools' ? Perf : clientPerfAdapter;
	  performance = clientPerfAdapter; //2025.9.19
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Canvas() {
	  var canvas = GameGlobal.bd_temp_canvas||tt.createCanvas();
